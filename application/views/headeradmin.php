...
<!-- //for-mobile-apps -->
<link href="<?php echo base_url('web/datatables/css/dataTables.bootstrap.css')?>" rel="stylesheet" type="text/css" media="all" />
<link href="<?php echo base_url('web/datatables/css/bootstrap.min.css')?>" rel="stylesheet" type="text/css" media="all" />
        ...
        <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
          <nav class="cl-effect-5" id="cl-effect-5">
            <ul class="nav navbar-nav">
              <li><a href="<?php echo site_url('Home/masuk_admin')?>" class="active">HOME</a></li>
              <li><a href="<?php echo site_url('Gejala/tambah_gejala')?>"><span data-hover="TAMBAH GEJALA">TAMBAH GEJALA</span></a></li>
              <li><a href="<?php echo site_url('Tips/tambah_tips')?>"><span data-hover="TAMBAH TIPS">TAMBAH TIPS</span></a></li>
              <li><a href="<?php echo site_url('Update/pilih_kategori')?>"><span data-hover="UPDATE">UPDATE</span></a></li>
              <li><a href="<?php echo site_url('login/logout');?>"><span data-hover="LOGOUT">lOGOUT</span></a></li>
            </ul>
          </nav>
        </div>
        <!-- /.navbar-collapse -->
